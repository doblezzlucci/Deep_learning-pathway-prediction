...
def run_multiproportion_finetuning(
        encoder,
        X_full, y_full,
        X_test, y_test,
        latent_dim,
    ...
    df.to_csv(os.path.join(save_dir, "finetune_results.csv"), index=False)
    print("Saved →", os.path.join(save_dir, "finetune_results.csv"))
